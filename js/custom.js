// JavaScript Document
	...
	function updateDownloadLinks() {
		const baseUrl = `https://github.com/ZeusLN/zeus/releases/download/v${version}`;
		const fileUrls = {
			apple: `${baseUrl}/zeus-mac-v${version}.dmg`,
			linux: `${baseUrl}/zeus-linux-x86_64-v${version}.AppImage`,
			windows: `${baseUrl}/zeus-win-v${version}.exe`,
		}
		let primaryUrl = 'https://github.com/ZeusLN/zeus/releases';
		let alt = 1;
